            ...
            <div className="max-w-[470px]">
              <div className="mb-6 rounded-lg border border-[#27272a] bg-[#0a0a0a] p-8 transition-colors duration-200 hover:border-[#52525b]">
                ...
                <p className="mb-4 text-base leading-relaxed text-[#a1a1aa]">
                  Faisal leads the vision and strategy at Focality, specializing in intelligent automation, AI solutions, robotic autonomous systems, and scalable architectures.
                </p>
              ...
              <div className="mb-6 rounded-lg border border-[#27272a] bg-[#0a0a0a] p-8 transition-colors duration-200 hover:border-[#52525b]">
                ...
                <p className="mb-4 text-base leading-relaxed text-[#a1a1aa]">
                  Jayanth architects the technical backbone of Focality, specializing in agentic workflows, AI/ML research, and scalable systems.
                </p>
                <div className="flex gap-4 text-sm text-[#71717a]">
